...
const welcomeEmailBody = (username) => {
    return emailLayout(`
    <p>Hello ${username},</p>
...
const resetPasswordBody = (username, resetUrl) => {
    return emailLayout(`
        <p>Hi ${username},</p>
...
const otpVerificationBody = (username, otp) => {
    return emailLayout(`
        <p>Hi ${username},</p>
...
const privateKeyRecoveryBody = (username, verificationUrl) => {
    return emailLayout(`
        <p>Hello ${username},</p>
...
export { resetPasswordBody, otpVerificationBody, welcomeEmailBody, privateKeyRecoveryBody, };
